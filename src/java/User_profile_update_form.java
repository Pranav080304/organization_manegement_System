 ...
 * @author prana
 */
public class User_profile_update_form extends HttpServlet
{
        ...
        if(session!=null)
         {
            ...
            if(user_id>0)
            {
                ...
                try
                {
                    ...
                    while(rs.next())
                    {
                        ...
                        lname=rs.getString("lname");
                            ...
                            out.println("<section class='content'>\n" +
                                        ...
                                        "              <!-- /.card-header -->\n" +
                                        "              <!-- form start -->\n" +
                                        "              <form action='User_profile_update' method='post' enctype=\"multipart/form-data\">\n" +
                                        "                <div class='card-body'>\n" +
                                        "				<div class='row'>\n" +
                    ...
                    RequestDispatcher alert=request.getRequestDispatcher("alert.html");
                    alert.include(request, response);
                }
