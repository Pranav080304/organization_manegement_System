 ...
 * @author prana
 */
public class product_edit_form extends HttpServlet
{
                         ...
                         while(rs.next())
                           {
                            ...
                            String form="<section class='content'>\n" +
                                        ...
                                        "                    <input type='text' class='form-control' value='"+pro_name+"'  name='pro_name' placeholder='Enter Product Name' >\n" +
                                        "                  </div>\n" +
                                        "                  <div class='form-group col-6'>\n" +
                                        "                    <label for='exampleInputPassword1'>Product Price</label>\n" +
                                        "                    <input type='number' class='form-control '  value='"+pro_price+"' name='pro_price' placeholder='Product Price'>\n" +
                                        "                  </div>\n" +
                                        "		    </div>\n" +
                                        "			<div class=\"col-sm-12\">\n"+
                                        "                      <div class=\"form-group\">\n" +
                                        "                           <label>Product Details</label>\n" +
                                        "                           <textarea class=\"form-control\" rows=\"3\"  value='"+pro_details+"' name='pro_details' placeholder=\"Enter Product Details\">"+pro_details+"</textarea>\n" +
                                        "                      </div>\n" +
                                        "                     </div>"+
                                        "                  <div class='form-group col-6'>\n" +
