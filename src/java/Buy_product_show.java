 ...
 * @author prana
 */
public class Buy_product_show extends HttpServlet
{
        ...
        if(session!=null)
         {
            ...
            if(user_id>0)
            {
                ...
                try
                {
                   ...
                   out.println(" <!-- Main content -->\n" +
                    ...
                    ResultSet rs=stml.executeQuery("select * from buy join product on buy.pro_id=product.pro_id where buy.user_id="+user_id+";");
                    while(rs.next())
                    {
            ...
            {
                out.println("Session error from Buy_product_show");
            }
        }
        else
        {
